...
const ProfileIcon = () => {
  return (
    <svg className='w-8' version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="20px" y="0px"
	 viewBox="0 0 25 25" enable-background="new 0 0 25 25">
        <path className='fill-white hover:fill-violet-600' d="M12.5,0C5.61,0,0,5.61,0,12.5c0,3.39,1.4,6.68,3.84,9.02c2.19,2.11,5.03,3.31,8.06,3.45
