...
const Register = () => {
    ...
    const handleChange = (e) => {
        ...
        setRegistro({...registro, [property]: value})

        validation(property, value, error, setError)
    }
    ...
    const handlerSubmit = async (e) => {
        ...
        if(registro.password !== registro.repetirPassword){
            ...
            try {
                ...
                setCampos(error.response.data.error)
            }
        }
  ...
  return (
    <div class="flex min-h-screen items-center justify-center">
      <div class="bg-white p-5 relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
        <h4 class="block font-sans font-extrabold text-2xl leading-snug tracking-normal text-violet-500 antialiased">
          Registro
        </h4>
        ...
        {campos && <p className="text-white p-2 w-100 text-center bg-red-800">{campos}</p>}
