        ...
        <form class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handlerSubmit}>
          <div class="mb-4 flex flex-col gap-6">
            ...
            <div class="relative h-11 w-full min-w-[200px]">
              <input
                type="password"
                className="peer h-full w-full rounded-md border border-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all  focus:border-none"
                placeHolder=" "
                onChange={handleChange}
                value={password}
                name='password'
              ...
              <Link
                class="font-semibold text-xs p-2 text-violet-500 transition-colors hover:text-blue-700"
                to="olvide-password"
              >
